...
def download_wavs(csv_path, audios_dir, mini_data):
    ...
    if mini_data:
        logs_dir = '_logs/download_dataset/{}'.format('eval_segments.csv')
    else:
        logs_dir = '_logs/download_dataset_minidata/{}'.format('eval_segments.csv')
    ...
    for (n, line) in enumerate(lines):
        ...
        if len(video_paths) > 0:
            ...
            audio_path = 'audios/eval_segments/Y' + audio_id + '.wav'
...
if __name__ == '__main__':
    download_wavs("./metadata/eval_segments.csv", "./audios/eval_segments", None)
